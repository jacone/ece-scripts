# constants used in several/all the ece-install modules.
...
PROFILE_ANALYSIS_DB_SERVER=13
PROFILE_VIP_PROVIDER=14
PROFILE_NFS_SERVER=15
PROFILE_NFS_CLIENT=16
PROFILE_DB_BACKUP_SERVER=17
PROFILE_UN_INSTALL=18
PROFILE_MONITORING_NODE=19
...
default_app_server_presentation_port=8040
