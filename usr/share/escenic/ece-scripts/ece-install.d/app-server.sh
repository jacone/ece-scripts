...
EOF
  ...
  ensure_app_server_is_using_log4j
  set_up_proper_logging_configuration_for_ece
}

function ensure_app_server_is_using_log4j() {
  print_and_log "Setting up Tomcat to use log4j ..."
  log4j_create_catalina_log4j_properties
...
function log4j_create_catalina_log4j_properties() {
  log "Creating catalina properties to use log4j ..."
  cat > $tomcat_base/lib/log4j.properties <<EOF  
...
function set_up_proper_logging_configuration_for_ece() {
