...
asking which *profile* you want to install:
#+BEGIN_SRC text
...
For example, to restore the DB, dta files, configuration & software
...
| ~fai_all_stop_and_clear~              | 0                                                 | After installation, stop the instances and clear its work & log files.                                                                |
