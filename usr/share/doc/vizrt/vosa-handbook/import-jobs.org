...
#+BEGIN_SRC text
<publEICAtion>/<import name>
<publEICAtion>/<import name>/transformers/<number>-<transformer task>.xsl
<publEICAtion>/<import name>/cron.hourly/<cron job script>
<publEICAtion>/<import name>/cron.every.<number>.minutes/<cron job script>
#+END_SRC

- publEICAtion name :: the name of the publEICAtion for which the import
     job(s) are defined. You can have more than one publEICAtion in
     each =zip= archive.
...
Cool Videos" and our publEICAtion is the ubiquitous =mypub=.
...
- =--import-user= :: (the ECE user which will be the author of the
     imported contents). Default is =<publEICAtion name>=_admin
