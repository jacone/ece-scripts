...
The proxy for <%=trail_customer_shortname%> requires a password that you can see [[http://secrets.vizrtsaas.com/<%25%3Dtrail_customer_acronym%25>/proxy.ini.asc][here]]
