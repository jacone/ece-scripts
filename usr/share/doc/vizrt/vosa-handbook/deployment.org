...
#+BEGIN_SRC sh
$ sudo ssh escenic@my-presentation-server ece -i engine1 --uri http://my-build-server/tomato/releases/tomato-trunk-rev4121-2012-07-05_1524.ear  deploy
...
#+BEGIN_SRC sh
torstein@control:~$ sudo ssh escenic@my-presentation-server ece -i search1 -t search --uri http://my-build-server/tomato/releases/tomato-trunk-rev4121-2012-07-05_1524.ear deploy
[ece#search-search1] Deploying http://my-build-server/tomato/releases/tomato-trunk-rev4121-2012-07-05_1524.ear on search1 ...
