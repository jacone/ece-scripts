...
12. On the form's *Mappings* tab, enter the following two mappings:
    ...
    |--------------------------------------------------------------------------+-------------------------------------------------------------------------|
    | publications/shared-war/src/main/webapp/template/                        | /opt/tomcat-engine1/webapps/[[<%= trail_publication_name %>]]/template/ |
    | publications/[[<%= trail_publication_name %>]]/src/main/webapp/template/ | /opt/tomcat-engine1/webapps/[[<%= trail_publication_name %>]]/template/ |
13. Click *OK*.
